...
PER OGNI elemento nella lista "listaInvitati":
...
Genera un numero per il giocatore: Prendi un numero a caso tra 1 e 6 e salvalo come "dadoGiocatore". Stampa questo numero sullo schermo.


Genera un numero per il computer: Prendi un altro numero a caso tra 1 e 6 e ricordatelo come "dadoComputer". Stampa anche questo numero.
